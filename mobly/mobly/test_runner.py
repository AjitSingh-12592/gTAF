...
def parse_mobly_cli_args(argv):
    ...
    parser.add_argument(
        ...
        type=str,
        metavar='[<device type>]',
        help='Specify on which device type test to be run')
    parser.add_argument(
        '-dm',
        '--device_model',
        nargs='+',
        type=str,
        metavar='[<device model>]',
        help='Specify on which device model test to be run')
    parser.add_argument(
        '-av',
        '--android_version',
        nargs='+',
        type=str,
        metavar='[<android version>]',
        help='Specify on which android version test to be run')
    if not argv:
        argv = sys.argv[1:]
