...
import random
import gTAF_config
from gTAF_config import uiElement
...
class Contacts(base_test.BaseTestClass):
    ...
    _selectors = ['Apps & notifications', 'Contacts', 'Storage', uiElement['CLEAR_CACHE'],
                  uiElement['CLEAR_STORAGE'], 'OK', 'Open navigation drawer', 'Suggestions',
    ...
    _create_all_contacts = OrderedDict([("Name prefix", "Mr."), ("First name", "testx"),
                                   ...
                                   ("Phonetic first name", "test5"), ("Nickname", "test6"), ("File as", "test7"),
    ...
    _strong_match_selector = ['Apps & notifications', 'Contacts', 'Storage', uiElement['CLEAR_CACHE'], uiElement['CLEAR_STORAGE'], 'Getting contacts',
    ...
    def test_CreateContact_Name(self):
      ...
      try:
        ...
        #self.dut.mbs.launchApp("com.android.contacts/.activities.PeopleActivity")
    ...
    def test_CreateContact_AllFields(self):
      ...
      for key in self._create_all_contacts:
          logging.info("Adding detail %s for : %s", self._create_all_contacts[key],  key)
      ...
      self.dut.mbs.pressBack()
      time.sleep(1)
      logging.info(name)#Mr. testx testy test1, test2test3
    ...
    def test_contact_permission_revoke_from_gmail(self):
      ...
      try:
        ...
        _pop_up_deny = self.pop_up_deny
        _pop_up_cancel = self.pop_up_cancel
    ...
    def test_contact_permission_grant_from_gmail(self):
      ...
      try:
        ...
        if _deny is True and _cancel is True:
          logging.info("Contacts permissions for Gmail enabled")
          self.dut.mbs.clickOnText(_pop_up_cancel)
          time.sleep(2)
        ...
        self.dut.mbs.clickOnText(_to)
        self.dut.mbs.inputText(input_name)
        self.dut.mbs.waitUntillDisplayElementWithText(expected_toast_text)
    ...
    def test_strong_match_for_duplicates(self):
        ...
        try:
            ...
            assert self.dut.mbs.waitUntillDisplayElementWithText("Merge 2 duplicates?") is True, "merge all pop up not found"
    ...
    def test_suggestion_welcome_card(self):
      ...
      try:
        ...
        if self._navigate_to_all_app_info():
            ...
            logging.info("Not clicked on See all app to expand.")
        # To Launch Settings
        # self.dut.mbs.launchSettings()
        for index in range(2, 6):
            logging.info("Click on %s :", self._selectors[index])
        ...
        self.dut.mbs.waitUntillDisplayElementWithText("Suggestions")
        ...
        time.sleep(2)
        assert self.dut.mbs.assertTextNotDisplayed(_suggestion_welcome_header) is True, "Welcome suggestions popup not dismissed"
    ...
    def test_google_play_service_permission_revoke(self):
      ...
      try:
          ...
          time.sleep(1)
          self.dut.mbs.launchApp(contacts_selectors.CONTACTS_LAUNCHER_ACTIVITY)
          self.dut.mbs.waitUntillDisplayElementWithContentDesc(_case_select[0])
    ...
    def test_favourite_in_all_contact(self):
        ...
        try:
            ...
            logging.info("Changing the orientation")
    ...
    def test_share_contacts(self):
        ...
        _selector = ["Share", "Gmail", "To", "Subject", "Send", "Save to Drive", self.save_btn, "Your 1 file is being uploaded to: My Drive","Unread me, " + _subject]
        ...
        time.sleep(2)
        assert self.dut.mbs.isOnline() is True, "Device is Offline"
        self.dut.mbs.waitUntillDisplayElementWithText(_selector[5])
        if self.dut.mbs.assertTextDisplayed(_selector[5]):
            self.dut.mbs.clickOnText(_selector[5])

        #self.dut.mbs.pressBack()
        self.dut.mbs.waitUntillDisplayElementWithText(self.save_btn)
        self.dut.mbs.clickOnText(self.save_btn)
        time.sleep(2)
    ...
    def __multiple_contacts(self, _contact):
    ...
    def _create_duplicate_contacts(self, _contacts):
      _dict_keys = ['First name', self.surname, 'Company']
      _selector = ["Create contact", self.save_btn]
    ...
    def _createContactLabel(self):
      ...
      if isLabelPresent:
        ...
        if isLabelChecked:
          ...
          self.dut.mbs.clickOnText(self.pop_up_cancel)
        else:
    ...
    def _deletAllContacts(self):
      time.sleep(2)
      logging.info("Delete all contacts")
      self.dut.mbs.waitUntillDisplayElementWithContentDesc("More options")
      self.dut.mbs.waitAndClickUsingContentDesc("More options")
    ...
    def _setContactPhoto(self):
      ...
      time.sleep(2)
      self.dut.mbs.waitUntillDisplayElementWithContentDesc("Take photo")
      self.dut.mbs.waitAndClickUsingContentDesc("Take photo")
      #self.dut.mbs.waitAndClickUsingContentDesc("Shutter")
      time.sleep(1)
      self.dut.mbs.waitAndClickUsingContentDesc("Done")
      self.dut.mbs.waitUntillDisplayElementWithText("Done")
