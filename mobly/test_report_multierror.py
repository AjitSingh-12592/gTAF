...
class Report:
    ...
    def _get_execution_results(self, jenkins_run_id=None, test_bed_name=None, test_case_name=None, jenkins_job_name=None):
        ...
        global results_csv_file_path
        global dev_serial_number
        ...
        #results_csv_file_path = gTAF_config.execution_summary_csv_file + '_' + \
        #                        self._get_serial(test_bed_name, gTAF_config.gTAF_home + 'gtaf_config.yml')

        dev_serial_number = self._get_serial(test_bed_name, gTAF_config.gTAF_home + 'gtaf_config.yml')

        print("Device ID : ", dev_serial_number)
        results_csv_file_path = '/gtaflog/execution_summary' + '_' + dev_serial_number + '.csv'
        print("CSV File : ", results_csv_file_path)
        i = 0
        test_name = "default"
    ...
    def csv_to_html(self):
        ...
        html_file = "/gtaflog/gTAF_report" + "_" + dev_serial_number + ".html"
    ...
    def execution_summary_dump(self):
        ...
        print("CSV File in execution_summary_sump :",results_csv_file_path)
        file_name = results_csv_file_path
        fields = []
        rows = []
        pass_count = 0
        fail_count = 0
